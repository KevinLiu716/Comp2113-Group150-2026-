// Expedition.cpp
// Implementation of expedition (daytime exploration) events.
// Each location has 2-3 narrative variants for replayability.
// Scout trait: any expedition member with the SCOUT trait grants a bonus
// resource on supply locations.
